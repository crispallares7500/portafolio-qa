# Portfolio QA – Cristina Hernández
...
🔗 [Ver Web Portfolio QA](https://crispallares7500.github.io/portafolio-qa/)
...
- Proyecto Supabase (requiere acceso): [Supabase Project](https://supabase.com/dashboard/project/qhhfkkreuaknsbbshmin)  

## 🗄 API de Formulario
Se ha generado una API que permite agregar, editar, consultar y eliminar datos de la base de datos creada en supabase.
- URL API (requiere acceso): [Supabase API](https://qhhfkkreuaknsbbshmin.supabase.co/rest/v1/form)  
- Documentación de la API: [Documentación API](https://crispallares7500.github.io/portafolio-qa/apidoc.html)
---
...
### Pruebas de API
- Colección en POSTMAN (requiere acceso): [POSTMAN Collection](https://crispallares7500-2003194.postman.co/workspace/form~fc442b20-7e8d-4a68-aa82-3336fe8b0500/collection/53431582-6d1e97e6-d865-4636-9a77-1d88e388aa55?action=share&source=copy-link&creator=53431582) 
...
## 👩‍💻 Autora
**Cristina Hernández – QA Junior**  
[🔗 LinkedIn](https://www.linkedin.com/in/cris-hernandez-30b590220))
